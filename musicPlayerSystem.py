...
root["bg"]="#195FBA"
#Theme Setting for Music Player
root.set_theme("elegance")
statusbar = ttk.Label(root, text="Welcome to Music Player by Deepanshu and Jayesh", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Music Player by Deepanshu and Jayesh", anchor=W, font='Arial 8 italic')
statusbar1.pack(side=TOP, fill=X)
#// Create the menubar for Music Player
menubar = Menu(root)
root.config(menu=menubar)
#// Create the submenu  for Music Player
subMenu = Menu(menubar, tearoff=0)
#list for storing play for Music Player
...
mixer.init()  #// initializing the mixer for Music Player
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found', 'Music Player could not find the file. Add mp3 files to library using : +Add  button.')

def stop_music():
    mixer.music.stop()
    statusbar['text'] = "Music Player has stopped the Music"
...
def pause_music():
    ...
    paused = TRUE
    mixer.music.pause()
    statusbar['text'] = "Music Player has paused  the Music"

def rewind_music():
    play_music()
    statusbar['text'] = "Music will be Rewinded"
...
scale.set(70)  # implement the default value of scale when Music Player music player starts
mixer.music.set_volume(0.7)
